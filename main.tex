...
\section{Use case descriptions for some main functions}
\begin{usecase}

\addtitle{Use Case 1}{A student takes a seat} 
...
\additemizedfield{Preconditions:}
{
    ...
    \item The class is turned on by the Teacher
    \item The Student is in the webpage of the Class
} 

\additemizedfield{Postconditions:}
{
    \item The Student occupied their desired seat
    \item If the teacher reloads his Class page, he can see the student on the classmap.
}

%Main Success Scenario: A typical, unconditional happy path scenario of success.
\addscenario{Main Success Scenario:}{
	\item The Student picks a seat.
	\item The page tells the Student that he picked the seat successfully.
	\item The page reloads and turns the star representing the picked seat into a large green star.
}

\addscenario{Alternate scenario:}{
	\item[2.a] A seat has been picked by another student
		\begin{enumerate}
		\item[1.] Page shows failure message
		\item[2.] Student returns to step 1
		\end{enumerate}
}
...
\addtitle{Use Case 2}{Doing a quiz} 
...
\additemizedfield{Preconditions:}
{
    \item Both the Student and the Teacher is logged in
    \item A quiz is created by the Teacher
    \item Both the Teacher and the Student is in the webpage of the Class
} 

\additemizedfield{Postconditions:}
{
    \item The quiz is completed. (which means the remaining time for the quiz reaches zero)
    \item The answer of the student is saved. If he cannot answer, it will be saved also.
    \item The Teacher can check for the result of the Student through the class map.
    \item The Teacher can check for the average result of the Students on the quiz.
    \item The Student can review his answer for the quiz.
}

%Main Success Scenario: A typical, unconditional happy path scenario of success.
\addscenario{Main Success Scenario:}{
	\item The teacher clicks on the "Show inactive questions"
	\item The application shows all quizzes that the teacher has created, but has not activated.
	\item The teacher clicks on the link of the quiz that he wants to activate.
	\item The application shows the page of the quiz.
	\item The teacher clicks "Activate quiz"
	\item The application begins to count down.
	\item The teacher returns to the Class page, and click on the button holding the name of the quiz to see the live update of the quiz through the class map.
	\item The application automatically shows the link to the quiz on the screen of the Student.
	\item The Student clicks on the link of the quiz.
	\item The application shows the page of the quiz.
	\item The student checks on the answer.
	\item The student clicks "Submit answer"
	\item The teacher sees the result of the student through the class map (the bottom frame will be colored green if the student answered right, and it will be red otherwise).
	\item The quiz counts to zero, and end itself.
}

\addscenario{Alternate scenario:}{
	\item[12.a] The student did not answer in time.
		\begin{enumerate}
		\item[1.] The application repleaces the button "Submit answer" with a "Time is over" line.
		\item[2.] The teacher sees the result of the student through the class map, with the bottom frame colored black.
		\end{enumerate}
}
...
\addtitle{Use Case 3}{Attention call} 
...
\additemizedfield{Postconditions:}
{
    \item The student and the teacher has a video call.
}

%Main Success Scenario: A typical, unconditional happy path scenario of success.
\addscenario{Main Success Scenario:}{
	\item The Student clicks the button "Call attention"
	\item The application tells the Student that the call is successful.
	\item The application colors the seat of that student red on the Teacher's screen, and beeps.
	\item The teacher clicks "Accept attention call"
	\item The application redirects both the teacher and the student to a video call page.
}

\addscenario{Alternate scenario:}{
    \item[2.a] There is another call at the moment
        \begin{enumerate}
		\item[1.] The application tells the Student that there is another call right now.
		\item[2.] Student returns to Step 1.
		\end{enumerate}
	\item[4.a] The teacher does not accept the call
		\begin{enumerate}
		\item[1.] The teacher clicks "Close attention call"
		\item[2.] The application stops beeping, and returns the class map to normal.
		\end{enumerate}
	\item[4.b] The student wants to cancel the calll
		\begin{enumerate}
		\item[1.] The student clicks "Cancel attention"
		\item[2.] The application stops beeping, and returns the class map to normal on the Teacher's screen.
		\end{enumerate}
}
